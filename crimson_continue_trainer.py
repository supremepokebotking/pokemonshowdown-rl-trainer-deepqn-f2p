...
MODEL_TO_LOAD = os.environ.get('MODEL_DIR', "showdown_a2c_weights_crimson_bcde887c-b0a1-4ef8-b916-42863a753606.h5")
...
model.load_weights('%s/%s' % (MODEL_DIR, MODEL_TO_LOAD))
