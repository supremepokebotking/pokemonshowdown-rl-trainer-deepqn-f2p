...
model_filenames = ["PokeEnv-v1_PokeDuelingDDQNRandomAgent_0.001_0.5_config_ver_2_q_next"]
...
for i in range(1):
    ...
    for _ in range(round_robin_match_nums):
        ...
        score = 0
        observation, _, _, info = env.reset(random_opponent=True)
        player = info["player"]
