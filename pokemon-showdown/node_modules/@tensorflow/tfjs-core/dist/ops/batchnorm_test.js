...
jasmine_util_1.describeWithFlags('batchNorm4D', test_util_1.ALL_ENVS, function () {
    it('simple batchnorm4D, no offset or scale, 2x1x1x2', function () { return __awaiter(_this, void 0, void 0, function () {
        var x, mean, variance, varianceEpsilon, result;
        return __generator(this, function (_a) {
            x = tf.tensor4d([2, 4, 9, 23], [2, 1, 1, 2]);
            mean = tf.tensor1d([1, 2]);
            variance = tf.tensor1d([2, 3]);
            varianceEpsilon = .001;
            result = tf.batchNorm4d(x, mean, variance, undefined, undefined, varianceEpsilon);
            test_util_1.expectArraysClose(result, [
    ...
    it('simple batchnorm4D, no offset, 2x1x1x2', function () {
        ...
        var varianceEpsilon = .001;
        var result = tf.batchNorm4d(x, mean, variance, undefined, scale, varianceEpsilon);
        test_util_1.expectArraysClose(result, [
    ...
    it('simple batchnorm4D, no scale, 2x1x1x2', function () {
        ...
        var varianceEpsilon = .001;
        var result = tf.batchNorm4d(x, mean, variance, offset, undefined, varianceEpsilon);
        test_util_1.expectArraysClose(result, [
            offset.get(0) +
                (x.get(0, 0, 0, 0) - mean.get(0)) * 1 /
                    Math.sqrt(variance.get(0) + varianceEpsilon),
...
jasmine_util_1.describeWithFlags('batchNorm3D', test_util_1.ALL_ENVS, function () {
    it('simple batchnorm3D, no offset or scale, 2x1x2', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            variance = tf.tensor1d([2, 3]);
            varianceEpsilon = .001;
            result = tf.batchNorm3d(x, mean, variance, undefined, undefined, varianceEpsilon);
            test_util_1.expectArraysClose(result, [
    ...
    it('simple batchnorm3D, no offset, 2x1x2', function () {
        ...
        var scale = tf.tensor1d([4, 5]);
        var varianceEpsilon = .001;
        var result = tf.batchNorm3d(x, mean, variance, undefined, scale, varianceEpsilon);
        test_util_1.expectArraysClose(result, [
    ...
    it('simple batchnorm3D, no scale, 2x1x2', function () {
        ...
        var offset = tf.tensor1d([4, 5]);
        var varianceEpsilon = .001;
        var result = tf.batchNorm3d(x, mean, variance, offset, undefined, varianceEpsilon);
        test_util_1.expectArraysClose(result, [
            offset.get(0) +
                (x.get(0, 0, 0) - mean.get(0)) * 1 /
                    Math.sqrt(variance.get(0) + varianceEpsilon),
...
jasmine_util_1.describeWithFlags('batchNorm2D', test_util_1.ALL_ENVS, function () {
    it('simple batchnorm2D, no offset or scale, 2x2', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            variance = tf.tensor1d([2, 3]);
            varianceEpsilon = .001;
            result = tf.batchNorm2d(x, mean, variance, undefined, undefined, varianceEpsilon);
            test_util_1.expectArraysClose(result, [
    ...
    it('simple batchnorm2D, no offset, 2x2', function () {
        ...
        var scale = tf.tensor1d([4, 5]);
        var varianceEpsilon = .001;
        var result = tf.batchNorm2d(x, mean, variance, undefined, scale, varianceEpsilon);
        test_util_1.expectArraysClose(result, [
    ...
    it('simple batchnorm2D, no scale, 2x2', function () {
        ...
        var offset = tf.tensor1d([4, 5]);
        var varianceEpsilon = .001;
        var result = tf.batchNorm2d(x, mean, variance, offset, undefined, varianceEpsilon);
        test_util_1.expectArraysClose(result, [
            offset.get(0) +
                (x.get(0, 0) - mean.get(0)) * 1 /
                    Math.sqrt(variance.get(0) + varianceEpsilon),
