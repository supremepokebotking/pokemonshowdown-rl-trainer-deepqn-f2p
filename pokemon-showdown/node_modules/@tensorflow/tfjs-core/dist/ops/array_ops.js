...
function fromPixels_(pixels, numChannels) {
    ...
    environment_1.deprecationWarn("tf.fromPixels() is renamed to tf.browser.fromPixels(), please switch " +
        "to the new method as the old method will be removed in TensorFlow.js " +
        "1.0.");
    return browser_1.fromPixels(pixels, numChannels);
}
function toPixels(img, canvas) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            environment_1.deprecationWarn("tf.toPixels() is renamed to tf.browser.toPixels(), please switch to " +
                "the new method as the old method will be removed in TensorFlow.js 1.0.");
            return [2, browser_1.toPixels(img, canvas)];
        });
    });
}
...
function unstack_(x, axis) {
    ...
    util.assert(axis < $x.shape.length, "Axis " + axis + " is >= to tensor shape length " + $x.shape.length);
    var grad = function (dy) {
...
exports.fromPixels = fromPixels_;
