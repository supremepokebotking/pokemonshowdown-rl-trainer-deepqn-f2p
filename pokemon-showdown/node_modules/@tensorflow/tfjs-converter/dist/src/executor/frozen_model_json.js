...
var operation_mapper_json_1 = require("../operations/operation_mapper_json");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.executor =
                            new graph_executor_1.GraphExecutor(operation_mapper_json_1.OperationMapper.Instance.transformGraph(graph));
...
function loadTfHubModule(tfhubModuleUrl, requestOption, onProgress) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2, loadFrozenModel("" + tfhubModuleUrl + exports.DEFAULT_MODEL_NAME + exports.TFHUB_SEARCH_PARAM, requestOption, onProgress)];
        });
    });
}
exports.loadTfHubModule = loadTfHubModule;
//# sourceMappingURL=frozen_model_json.js.map